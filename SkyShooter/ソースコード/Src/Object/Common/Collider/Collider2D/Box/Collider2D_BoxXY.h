...
/// XY平面上の矩形の2Dコライダ
/// </summary>
class Collider2D_BoxXY :
    public Collider2D_Box
{
public:

	Collider2D_BoxXY(void) = default;
	...
	explicit Collider2D_BoxXY(const ColliderData_2D& colData, const bool colliderDef = true);
	virtual ~Collider2D_BoxXY(void);
